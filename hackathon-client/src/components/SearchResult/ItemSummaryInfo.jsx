...
export const ItemSummaryInfo = (props) => {
	const { itemName, imagePath, isRecyclable, councilName, categoryName } = props;
	...
	return (
		<section className={styles.itemSummaryInfo}>
			<div className={styles.itemImageWrapper}>
				<Link to={"/"}>
					<button className={styles.backButton}>
						<img src="./assets/Icons/arrow_back.svg" alt="back button" />
					</button>
				</Link>
			...
			<header>
				...
				<div className={styles.itemNameWrapper}>
					...
					{isRecyclable ? (
						<img
							...
							src="/public/images/recyclable-icon.svg"
							alt="recyclable symbol"
						/>
					) : (
						<></>
					)}
				...
				{categoryName && (
					<button className={styles.categoryName}>
						<p>{categoryName}</p>
					</button>
				)}
			</header>
